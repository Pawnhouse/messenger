    ...
    >
      <div className='px-5'>
        <div className='flex justify-between mb-4 pt-4'>
          ...
          <div
            onClick={() => { setSearchValue(''); setIsDelete(!isDelete) }}
            className='
                rounded-full 
                p-1 
                bg-gray-100 
        ...
        <div className='flex items-center'>
          <div className='relative w-full'>
            <input type='text' id='user-search' value={searchValue} onChange={(e) => { setSearchValue(e.target.value); setIsDelete(false) }} className='bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500' placeholder='Search' required />
          </div>
